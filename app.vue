...
const isAppHome = computed(() => {
	...
	return firstAppSegment === 'home' || firstAppSegment === 'explore' || firstAppSegment === 'assets' || firstAppSegment === 'ai-image-generator' || firstAppSegment === 'ai-video-generator' || firstAppSegment === 'tools' || firstAppSegment === 'account'
})
