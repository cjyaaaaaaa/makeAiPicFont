        ...
        >
          ...
          >
            ...
            <div class="w-full max-w-[400px]">
              ...
              <!-- Google 渲染按钮覆盖在自定义按钮上，用户点击时实际点击的是 Google 按钮 -->
              <div style="position: relative; width: 100%;">
                <div
                  ref="googleOverlayRef"
                  style="position: absolute; inset: 0; z-index: 1; overflow: hidden; opacity: 0.001; cursor: pointer;"
                ></div>
                <button
                  type="button"
                  class="google-btn"
...
const loadGoogleScript = (): Promise<void> => {
  ...
  return new Promise<void>((resolve, reject) => {
    ...
    if (existing) {
      ...
      window.setTimeout(() => { window.clearInterval(timer); reject(); }, 8000);
      return;
    }
